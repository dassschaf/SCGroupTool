...
INSERT INTO cargo_lot (salvage_run_id, cargo_type_id, station_id, amount)
VALUES (1, 4, 1, 234);
INSERT INTO cargo_lot (cargo_type_id, salvage_run_id, station_id, amount)
VALUES (1, 5, 1, 30);
INSERT INTO cargo_event (salvage_run_id, station_id, type, finishes_at, fees, price_per_unit, created_cargo_lot_id)
VALUES (1, 1, 'REFINE', now() + interval '10 hour', 1234, 0, 5);
...
INSERT INTO claim_fees (salvage_run_id, fees, ship, system)
VALUES (1, 20000, '890 Jump', 'Stanton'),
       (1, 500, 'C2 Hercules', 'Stanton');